...
if (NOT TARGET Qt5::qmake)
    ...
    set(imported_location "${_qt5Core_install_prefix}/.hostprefix/bin/qmake")
...
if (NOT TARGET Qt5::moc)
    ...
    set(imported_location "${_qt5Core_install_prefix}/.hostprefix/bin/moc")
    _qt5_Core_check_file_exists(${imported_location})
...
if (NOT TARGET Qt5::rcc)
    ...
    set(imported_location "${_qt5Core_install_prefix}/.hostprefix/bin/rcc")
    _qt5_Core_check_file_exists(${imported_location})
